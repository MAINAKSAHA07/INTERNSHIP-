            ...
            <div className="bg-[url('/public/images/TLN-Adults-Korean-Banner.jpg')] bg-no-repeat bg-cover bg-center h-[70vh]" >
                <div className="bg-[rgba(0,0,0,0.4)] h-full ">
                    <div className='h-full flex flex-col justify-center align-left w-full px-10 lg:px-32'>
                        ...
                        <h1 className='text-md my-10 text-white font-medium'>1-to-1 and Group Online Korean classes for adults (18+ years old) with professional teachers.</h1>
            ...
            <div className="sm:px-3 lg:px-14 sm:mx-0 lg:mx-5">
                ...
                <div className='inline hidden sm:block'>
                    ...
                    <div className='flex lg:justify-around sm:justify-center '>
                        <iframe width="360rem" height="222rem" src="https://www.youtube.com/embed/sSm5cqvVSEc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
