            ...
            <div className="KidsFrench h-[70vh]" >
                <div className="bg-[rgba(0,0,0,0.4)] h-full ">
                    <div className='h-full flex flex-col justify-center align-left w-full px-10 lg:px-32'>
                        ...
                        <h1 className='text-md my-10 text-white font-medium'>1-to-1 and Group Online French classes for kids (6-17 years old) with professional teachers.</h1>
                ...
                <div className='w-full flex flex-col w-full lg:w-2/3'>
                    <div className='flex flex-row group h-auto px-10 lg:px-16 py-2'>
                        ...
                        <div>
                            ...
                            <p className='text-[#54595f] pt-2'>When children are introduced to a new language, their empathy toward that language increases. They start accepting diversity within their friends’ circles and gain new perspectives on various customs and traditions!</p>
                        </div>
                    </div>
                    <div className='flex flex-row group h-auto px-10 lg:px-16 py-2'>
                        <div className='h-full pt-2 ease-in duration-300 text-teal-300 group-hover:text-amber-400'>
                        ...
                        <div>
                            ...
                            <p className='text-[#54595f] pt-2'>Children have the most interesting minds! By learning a language like French, they could come back home and mimic a French play or have a small mini France in the room! This improves their imaginative skills and tingles their creative minds!</p>
                        </div>
                    </div>
                    <div className='flex flex-row group h-auto px-10 lg:px-16 py-2'>
                        <div className='h-full pt-2 ease-in duration-300 text-teal-300 group-hover:text-amber-400'>
                        ...
                        <div>
                            ...
                            <p className='text-[#54595f] pt-2'>Energetic, vibrant, spirited! This describes children precisely as they are! With energy to spare, they have the ability to multitask and learn more than two things at the same time. Learning a second language boosts their skills at multitasking!</p>
                        </div>
                    </div>
                    <div className='flex flex-row group h-auto px-10 lg:px-16 py-2'>
                        <div className='h-full pt-2 ease-in duration-300 text-teal-300 group-hover:text-amber-400'>
                        ...
                        <div>
                            ...
                            <p className='text-[#54595f] pt-2'>Often wondered what qualities make up the perfect youth? What if, growing up, a child was embedded with all the pivotal attributes to add to their forte? This is possible through learning a new language. Research proves that it feeds their brain and boosts critical thinking, memory capacity, concentration, and mental flexibility! What more benefits can you ask for!? </p>
                        </div>
                    </div>
                </div>
            </div>
